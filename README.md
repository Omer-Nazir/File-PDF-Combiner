...
## Download
### Note
Please note that the Windows Defender might find these files harmful and may give false positive beacuse this project is not from an unkown publisher. You can continue without any worries.
...
Also do not forget to add this file to exception list in windows defender. [Here is how to do it](https://support.microsoft.com/en-us/windows/add-an-exclusion-to-windows-security-811816c0-4dfd-af4a-47e4-c301afe13b26#:~:text=Go%20to%20Start%20%3E%20Settings%20%3E%20Update,%2C%20file%20types%2C%20or%20process.)
...
(*does not support drag and drop feature for external files and have some minor bugs (with minimal affect of user experience) given in [Bugs Section](#bugs))
...
## Bugs
### Modern UI
1. Changing the Windows Theme mode does not update TreeView style
2. Top-level windows do not open in focus, and their icons are replaced with the default Tkinter icon rather than the intended one.

## TODO
- Enabling Drag and Drop in Modern UI, so that Simple UI can be discontinued
